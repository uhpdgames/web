    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        if (result) {
          ...
          if (id_city > 0 && id_district > 0 && id_wards > 0)
...
NN_FRAMEWORK.FixMenu = function () {
  $(window).scroll(function () {
    if ($(window).scrollTop() >= $(".wap_thongtin").height())
        ...
        $.ajax({
          ...
          success: function (result) {
            ...
            if (result.max) {
              ...
              $(".wrap-cart").html(
                '<a href="javascript:void(0);" class="empty-cart text-decoration-none"><i class="fa fa-cart-arrow-down"></i><p>' +
