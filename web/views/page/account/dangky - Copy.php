	        ...
	        <form class="form-user validation-user" novalidate method="post" action="account/dang-ky"
	            ...
	            <div class="wp-input">
	                ...
	                <div class="form-holder checkdieukhoan">
	                    <!--<input type="checkbox" style="transform: translateY(11%); margin-right: 0.15rem;"
						   id="check-confrim">-->
	            ...
	            <a href="#" onclick="fb_login();"><img src="assets/images/hotro_face.png" border="0" alt=""></a>
	            ...
	            <!--	<div class="form-holder w-100 wp-action w-100 vw-100 m-0">
				<span style="font-weight: bold; color: #2b4c1f; font-size: .85rem">Hoặc Đăng ký bằng</span>
			</div>-->
	            ...
	            <!--<div style="display: none" class="fb-login-button" data-width="50" data-size="" data-button-type=""
				 data-layout="" data-auto-logout-link="true" data-use-continue-as="false"></div>-->
	...
	<!--<div id="g_id_onload" data-client_id="63359959323-88e9odjoprlrqqejsrrt7d4gk13093gr.apps.googleusercontent.com"
